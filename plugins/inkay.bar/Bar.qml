...
Item {
  ...
  property var barConfig: ({ position: "top", transparent: false, layout: { left: [], center: [], right: [] } })
  ...
  property int floatingSideGap: 10
  ...
  component BarPanel: PanelWindow {
    ...
    margins {
      top: root.barHidden ? (root.position === "top" ? -root.barSize : 0) : root.floatingGap
      bottom: root.barHidden ? (root.position === "bottom" ? -root.barSize : 0) : root.floatingGap
      left: root.barHidden ? (root.position === "left" ? -root.barSize : 0) : root.floatingSideGap
      right: root.barHidden ? (root.position === "right" ? -root.barSize : 0) : root.floatingSideGap
    }
